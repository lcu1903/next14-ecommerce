...
const products: Product[] = [
  { id: 1, name: "Guitar 1",description:"description A", amount: 5, price: 100, type: "Electric" },
  { id: 2, name: "Guitar 2",description:"description B", amount: 3, price: 150, type: "Acoustic" },
  { id: 3, name: "Guitar 3",description:"description C", amount: 2, price: 200, type: "Electric" },
  { id: 4, name: "Guitar 4",description:"description D", amount: 7, price: 120, type: "Acoustic" },
  { id: 5, name: "Guitar 5",description:"description E", amount: 4, price: 180, type: "Electric" },
];
  ...
  return (
    <div>
      ...
      <div className="rounded-md bg-sub-content p-2 ">
        ...
        <table className="m-2 w-[70%] h-max rounded-md bg-sub-content outline outline-offset-4">
          <thead>
